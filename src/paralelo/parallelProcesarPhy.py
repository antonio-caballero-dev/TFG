...
def crear_directorios_salida(conjunto: str):
    output_dir = f"./Outputs/paralelo/{conjunto}"
...
def procesar_secuencias(nOrganismos: int,
    ...
    # print(secuencias_codificadas)
    nProcesadores = nCores
    print(f"Numero de procesadores: {nProcesadores}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--nCores", type=int, default=1, help="Numero de procesadores a utilizar")
    ...
    #Cores
    nCores = args.nCores
    print(f"Numero de cores: {nCores}")

    #1. Leer el archivo phy
    ...
    # 3. Extraer informacion del archivo .nwk del arbol de verdad
    ...
    # 4. Crear flujos de escritura para las salidas
    ...
    metodos_imputacion = (
        None,
        parallelGlobalImputer.SimpleImputer_mean,
        parallelGlobalImputer.SimpleImputer_median,
        parallelGlobalImputer.SimpleImputer_most_frequent,
        parallelGlobalImputer.IterativeImputer_BayesianRidge,
        parallelGlobalImputer.IterativeImputer_KNeighborsRegressor,
        # parallelGlobalImputer.IterativeImputer_HistGradientBoostingRegressor,
        parallelGlobalImputer.IterativeImputer_LinearSVR,
        # parallelGlobalImputer.IterativeImputer_MLPRegressor,
        parallelGlobalImputer.IterativeImputer_GaussianProcessRegressor,
        parallelGlobalImputer.IterativeImputer_PLSRegression,
        parallelGlobalImputer.IterativeImputer_IsotonicRegression,
        parallelGlobalImputer.KNNImputer,
        # parallelGlobalImputer.BiologicalImputer,
        parallelGlobalImputer.AlternativeImputer,
        parallelGlobalImputer.NullImputer
    )
    ...
    print(f"  Tiempo de procesamiento del fichero {archivo_phy} con {nCores} cores: {end_time - start_time} segundos")